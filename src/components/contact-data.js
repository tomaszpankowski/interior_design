        ...
        return(        
            <Container fluid className={"contact-s1 align-items-center p-0 d-flex minh-50vh "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 pt-5">
                    <Col xs={10} md={4} className="mx-auto ms-md-0 text-dark p-0">
                    </Col>
                    <Col xs={10} md={5} className="mx-auto ms-md-0 text-dark p-0 d-flex align-items-center">
                        <div className="p-5">
                            <h1 className="display-4 fw-bold font-logo text-dark">
                                Contact us
                            </h1>
